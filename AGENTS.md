...
- Non-document skill execution lives in `server/rag/agent-skill-runners.js`; keep research brief, inventory, document discovery, custom skill chain, and web search execution details there rather than expanding `server/rag/agent.js`.
