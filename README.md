...
| AgentRAG | Planner、白名单 skill chain、self-check、gap analysis、follow-up retrieval、finalizer、scope-aware task log 和 runner-based job orchestration 已完成初版；task/job 支持 PostgreSQL 持久化、审计事件和启动恢复。 |
